...
public:
	...
	bool getAccountInfo(const std::string accountNumber, float &balance, float &credit, float &disposalBalance, float &interest, int &withdrawCount, Type &type) const;

	bool createNewAccount(const Type type);
